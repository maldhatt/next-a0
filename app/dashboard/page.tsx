// @ts-nocheck - Suppressing TypeScript errors for Recharts components
'use client';

// @ts-ignore - Recharts has TypeScript issues with JSX components
...
export default function DashboardPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <p className="text-gray-500 mb-6">Welcome to your analytics dashboard</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Monthly user acquisition and sessions</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-80">
              {/* @ts-ignore */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Quarterly financial overview</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-80">
              {/* @ts-ignore */}
